...
def plot_html(dates, wealth_data, individual_count, trend_data, group_label, group_desc, show=True):
    ...
    fig = make_subplots(
        ...
        column_widths=[1 - unified_params['sparkline_inset'][2], unified_params['sparkline_inset'][2]],
        row_heights=[
    ...
    fig.add_trace(go.Scatter(
        x=dates, y=wealth_data[1]/individual_count, 
        mode='lines',
        line=dict(color='white', width=2), 
        showlegend=False, 
        hoverinfo='skip'
